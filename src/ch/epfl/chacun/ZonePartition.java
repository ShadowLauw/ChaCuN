 ...
 * @param areas (Set<Area<Z>>) the areas of the zone partition
 *
...
public record ZonePartition<Z extends Zone> (Set<Area<Z>> areas) {
     ...
     *
     * @param zone (Z) the zone to check
     ...
     * @param <Z> the type of the zones
     * @param zone (Z) the zone to check
     * @param areas (Set<Area<Z>>) the areas to check
     * @return (Area<Z>) the area containing the given zone
     *
     * @throws IllegalArgumentException if the zone is not in any area of the partition
     */
    ...
    public static final class Builder<Z extends Zone> {
         ...
         *
         * @param zonePartition (ZonePartition<Z>) the zone partition
         */
         ...
         * @param zone (Z) the zone of the area
         * @param color (PlayerColor) the color of the occupant
         *
         ...
         *
         * @return (ZonePartition<Z>) the zone partition
         */
